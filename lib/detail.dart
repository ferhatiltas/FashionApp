...
class _DetailState extends State<Detail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
     children: [
       Hero( // main.dart kısmında da tıklanan öğeyi Hero içine alırsak resimi açtıktan sonra geri gelirse resim güzel bir efekt ile yerine oturu tag: lar aynı olmalı
         tag: widget.imgPath,
         child: Container(
